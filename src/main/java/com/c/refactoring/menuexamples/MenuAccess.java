...
public class MenuAccess {
    ...
    public void setAuthorizationsInEachMenus(List<MenuItem> menuItems, Role[] roles) {
        ...
        menuItems.stream().forEach(menuItem -> setAccessForMenuItem(menuItem, roles));
    }
    ...
    private static boolean doesUserHaveTheRole(Role[] roles, String roleToCheck) {
        return Arrays.stream(roles)
                .anyMatch(role -> role.getName().equals(roleToCheck));
    }
}
